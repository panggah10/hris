...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $log_query = "INSERT INTO `riwayat perubahan kontrak` (id_kontrak, tanggal_perubahan, gaji_sebelum_perubahan, gaji_setelah_perubahan, keterangan_perubahan) VALUES ('$id_kontrak', '$tanggal_perubahan', '$gaji_sebelum_perubahan', '$gaji_setelah_perubahan', '$keterangan_perubahan')";
